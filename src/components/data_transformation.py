...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        this function will return the preprocessing object that we will use to do data transformation for both 
        ...
        try:
            ...
            logging.info("numerical and categorical piplines created")

            proprocessor=ColumnTransformer(
                [
                    ("numerical_pipline",num_pipline,self.numerical_columns),
                    ("categorical_pipline",cat_pipline,self.categorical_columns)
                ]
            )
